    ...
    <div class="col-12 mx-auto">
        <div class="card">
            <div class="card-body order-list">
                ...
                {{ Form::open(['route' => 'admin.products.store','id'=>'roles-form']) }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row required">
                            ...
                            <div class="col-sm-8">
                                {{Form::text('sku', '', ['class' => 'form-control', 'placeholder'=>'SKU',  'pattern'=>'[A-Z]{2}',  'title'=>'2 capital letters'])}}
                    ...
                    <div class="col-md-6">
                        <div class="form-group row required">
                            ...
                            <div class="col-sm-8">
                                {!! Form::select('category_id', ['' => 'Select Category']+ $parentcategories, null, ['id' =>'category_id','class' => 'form-control select2']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group row required">
                            ...
                            <div class="col-sm-8">
                                {!! Form::select('channel_id', ['' => 'Select Channel']+ $channels, null, ['id' =>'channel_id','class' => 'form-control select2']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group row required">
                            ...
                            <div class="col-sm-8">
                                {{Form::text('point_slab', null , ['class' => 'form-control', 'placeholder'=>'Point Slab'])}}
