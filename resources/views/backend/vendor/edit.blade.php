            ...
            <div class="col-12 mx-auto">
                <div class="card">
                    <div class="card-body order-list">
                        ...
                        {{ Form::model($editModeData,['route' =>['admin.vendors.update',$editModeData->id ],'method' => 'PUT','files'=>'true','id'=>'thanas-form'])}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('vendor_name', $editModeData->vendor_name, ['class' => 'form-control',  'placeholder'=>'Vendor name'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('contact_person', $editModeData->contact_person, ['class' => 'form-control', 'placeholder'=>'Contact Person'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('mobile', $editModeData->mobile, ['class' => 'form-control', 'placeholder'=>'Mobile'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::textarea('address', $editModeData->address, ['id' =>'address','class' => 'form-control', 'rows' => 5, 'placeholder'=>'Address']) !!}
