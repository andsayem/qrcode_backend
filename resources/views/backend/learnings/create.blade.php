        ...
        <div class="card">
            <div class="card-body order-list">
                <h3 class="header-title mt-0 mb-3">
                    Add New Learning and Tutorial
                </h3>
                <hr/>
                {{ Form::open(['route' => 'admin.learnings.store','id'=>'roles-form','files'=>true]) }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row" id="linkField">
                            ...
                            <div class="col-sm-8">
                                {{Form::text('path', '', ['class' => 'form-control',  'placeholder'=>'Enter Youtube Link'])}}
                    ...
                    <div class="col-md-6">
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-8">
                                {!! Form::textarea('description', '', ['id' =>'desc','class' => 'form-control', 'rows' => 5, 'placeholder'=>'Description']) !!}
                                @include('/includes/validationmessages', ['field_name'=>'desc'])
                            </div>
                        </div>
                    </div>
