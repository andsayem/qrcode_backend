            ...
            <div class="col-12 mx-auto">
                <div class="card">
                    <div class="card-body order-list">
                        ...
                        {{ Form::model($editModeData,['route' =>['admin.categories.update',$editModeData->id ],'method' => 'PUT','files'=>'true','id'=>'thanas-form'])}}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('category_name', $editModeData->category_name, ['class' => 'form-control',  'placeholder'=>'Category name'])}}
                            ...
                            {{--<div class="col-md-6">
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('parent_id', ['' => 'Select Parent Category']+ $parentcategories, $editModeData->parent_id, ['id' =>'parent_id','class' => 'form-control select2']) !!}
