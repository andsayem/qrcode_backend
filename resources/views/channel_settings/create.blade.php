...
<div class="block-header">
    <div class="row">
        <div class="col-lg-5 col-md-8 col-sm-12">
            <h2>Channel Settings Create</h2>
        </div>
        <div class="col-lg-7 col-md-4 col-sm-12 text-right">
            <ul class="breadcrumb justify-content-end">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="icon-home"></i></a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.categories.index') }}">Channel Settings</a></li>
                    <li class="breadcrumb-item active">Create Channel Settings</li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row required">
                            ...
                            <div class="col-sm-8">
                                {{Form::text('settings_name', '', ['class' => 'form-control',  'placeholder'=>'Value'])}}
                                @include('/includes/validationmessages', ['field_name'=>'settings_name'])
                            </div>
                        </div>
                    </div>
...
<!--                     {{--<div class="col-md-6">
                        <div class="form-group row ">
                            <label for="role" class="col-sm-4 col-form-label control-label">Slab Value </label>
                            <div class="col-sm-8">
                                {!! Form::select('parent_id', ['' => 'Select Parent Settings']+ $parentcategories, null, ['id' =>'parent_id','class' => 'form-control select2']) !!}
...
<!--                     <div class="col-md-6">
                    ...
                    <div class="col-md-12 text-right">
                        <div class="form-group">
                            <button type="submit" class="btn btn-success waves-effect waves-light mt-2"><i class="ti-check-box mr-2"></i>Done</button>
                        </div>
                    </div>
                </div>
                <!--end /div-->
