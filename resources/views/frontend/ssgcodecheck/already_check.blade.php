    ...
    <main class="container">
        <div class="row align-items-center ssg-height-inner">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ssg-left">
                <h2 class="mb-4 text-danger">Alert! This code has already been scanned/checked by {{ substr_replace($ssgcodedetail->mobile,'*****',5,5) ?? '' }}. If it is not you please contact with your seller.</h2>
