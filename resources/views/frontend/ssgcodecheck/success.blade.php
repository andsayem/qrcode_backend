...
<header>
    ...
    <nav class="navbar navbar-expand-md bg-primary">
        <div class="container justify-content-between">
            <a class="nav-link text-white font-14" aria-current="page" href="mailto:info@ssgbd.com"> <i
                    class="fa fa-envelope me-2"> </i>info@ssgbd.com</a>
            <a class="nav-link text-white font-14" aria-current="page" href="tel:+8809610774774"> <i
                    class="fa fa-phone me-2"> </i>+88-09610-774774</a>
        </div>
    </nav>
...
<main class="container">
    <div class="row align-items-center ssg-height-inner">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ssg-left">
            <h2 class="mb-4 text-success">Verified! This is an original product from Super Star Group (SSG). Thank you
                for choosing us.</h2>
...
<footer class="footer mt-auto py-3 bg-dark">
    <div class="container text-center">
        <span
            class="text-white">© {{ getCurrentYear() }} SSGESHOP All Rights Reserved. | Tech Support by SSL Wireless</span>
    </div>
</footer> <!-- end footer -->
